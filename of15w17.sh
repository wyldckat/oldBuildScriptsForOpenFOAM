...
wget -c http://modular.openfoam-ubuntu.googlecode.com/hg/of17x/files/ThirdParty_Allwmake.diff
patch -p0 < ThirdParty_Allwmake.diff
wget -c http://openfoam-ubuntu.googlecode.com/hg/build-gcc_v4.tar.gz
